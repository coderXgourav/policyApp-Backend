                  ...
                  <thead class="text-left">
                    <tr class="bg-neutral-20 dark:bg-neutral-903">
                      ...
                      <th class="px-6 duration-300"
                        ...
                        <th class="px-6 duration-300"
                        :class="dense? 'py-2': 'py-3 lg:py-5'">Open Question</th>
                    </tr>
                  </thead>
                  <tbody>
                    {{-- <template x-for="file in items"> --}}
                      ...
                      <td class="px-6" :class="dense? 'py-1.5': 'py-3'">
                       <a href="{{url('/admin/show-question')}}/{{$value->policy_id}}"><button class="btn btn-warning">View Question</button></a>
                      </td>
