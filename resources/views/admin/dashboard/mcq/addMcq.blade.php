...
<style>
    ...
    >
    <form id="form">
<input type="hidden" id="url" value="/admin/add-mcq">
<input type="hidden" id="method" value="POST">
<input type="hidden" id="btnName" value="Submit Question">
    {{@csrf_field()}}
              ...
              <div class="n20-box">
                <div class="grid grid-cols-2 gap-4 xxl:gap-6 my-6">
                    ...
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-12">
                      ...
                      <input type="text" name="question" id="name" placeholder="Type Question Here..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required />
                    </div>
                  </div>
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                      ...
                      <input type="text"name="option_a"  id="text" placeholder="Option A answer..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required />
                    </div>
                  </div>
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                      <label for="number"  class="absolute -top-2 bg-neutral-20 px-2 text-xs dark:bg-neutral-903">Option B</label>
                      <input type="text" name="option_b" id="number" placeholder="Option B answer..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required/>
                    </div>
                  </div>
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                      <label for="state" class="absolute -top-2 bg-neutral-20 px-2 text-xs dark:bg-neutral-903">Option C</label>
                      <input type="text" name="option_c" id="state" placeholder="Option C answer..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required />
                    </div>
                  </div>
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                      <label for="city" class="absolute -top-2 bg-neutral-20 px-2 text-xs dark:bg-neutral-903">Option D</label>
                      <input type="text" name="option_d" id="city" placeholder="Option D answer..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required/>
                    </div>
                  </div>
                ...
                <div class="flex gap-4 xxl:gap-6">
                  <button class="btn-primary" id="btn">Submit Question</button>
                </div>
              </div>
            </div>
          </div>
