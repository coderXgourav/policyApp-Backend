      ...
      <div
        ...
        <div x-data="{activeTab:'list'}" class="white-box">
          <div class="flex justify-between items-center bb-dashed-n30">
            <h4>Assigned Policy Lists</h4>
            <a href="{{url('/admin/assign-policy')}}"><button class="btn-primary-outlined"><i class="las la-upload"></i>
                ...
                <table class="w-full whitespace-nowrap">
                  <thead class="text-left">
                    <tr class="bg-neutral-20 dark:bg-neutral-903">
                      ...
                      <th class="px-6 duration-300"
                        ...
                        <th class="px-6 duration-300"
                        :class="dense? 'py-2': 'py-3 lg:py-5'">Employee Dept.</th>
                      <th class="px-6 duration-300"
                        :class="dense? 'py-2': 'py-3 lg:py-5'">Employee Name</th>
                        <th class="px-6 duration-300"
                        :class="dense? 'py-2': 'py-3 lg:py-5'">Employee Email</th>
                        <th class="px-6 duration-300"
                  ...
                  <tbody>
                    {{-- <template x-for="file in items"> --}}
                      ...
                      :class="file.checked?'!bg-primary-300/10':'bg-neutral-0 dark:bg-neutral-904'" id="{{$value->policy_assign_to_employee_id}}">
                      ...
                      <td class="px-6" :class="dense? 'py-1.5': 'py-3'">
                        <span class="m-text" >{{$value->employee_name}}</span>
                      </td>
                      <td class="px-6" :class="dense? 'py-1.5': 'py-3'">
                        <span class="m-text" >{{$value->employee_email}}</span>
                      </td>
