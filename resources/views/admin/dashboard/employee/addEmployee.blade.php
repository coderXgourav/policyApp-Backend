                ...
                <div class="grid grid-cols-2 gap-4 xxl:gap-6 my-6">
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                      ...
                      <input type="text" name="name" id="name" placeholder="Enter Name..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required />
                    </div>
                  </div>
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                      <label for="email" class="absolute -top-2 bg-neutral-20 px-2 text-xs dark:bg-neutral-903">Your Email</label>
                      <input type="email"name="email"  id="email" placeholder="Enter Email..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required />
                    </div>
                  </div>
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                  ...
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                      ...
                      <input type="password" name="password" id="password"  placeholder=" Password..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required />
                    </div>
                  </div>
                  ...
                  <div class="col-span-2 md:col-span-1">
                    <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                      ...
                      <input type="password" id="confirm_password" name="confirm_password" placeholder="Confirm Password..." class="w-full s-text bg-transparent py-2.5 xl:py-3.5" required  />
                    </div>
                  </div>
