            ...
            <li class="relative">
              ...
              <div x-show="opened=='department'" x-collapse>
                <ul
                  ...
                  <li>
                    <a href="{{url('/admin/view-assign-policy-department')}}"
                      class="py-2.5 px-3 hover:text-primary-300 duration-300 inline-flex submenu-link-v">View Assigned Policy to Department</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="relative">
              ...
              <div x-show="opened=='invoice'" x-collapse>
                <ul
                  ...
                  <li>
                    <a href="{{url('/admin/assign-policy')}}"
                      class="py-2.5 px-3 hover:text-primary-300 duration-300 inline-flex submenu-link-v">Assign Policy to Employee</a>
                  </li>
                  <li>
                    <a href="{{url('/admin/view-assign-policy')}}"
                      class="py-2.5 px-3 hover:text-primary-300 duration-300 inline-flex submenu-link-v">View Assign Policy</a>
                  </li>
                </ul>
              </div>
            </li>
